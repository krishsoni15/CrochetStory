...
function CustomOrderForm({ onClose }) {
  ...
  return (
    <motion.div
      ...
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      className="fixed top-0 left-0 right-0 bottom-0 bg-black/50 backdrop-blur-md flex items-center justify-center z-[9998] p-4"
      onClick={handleClose}
    >
      <motion.div
        ...
        onClick={(e) => e.stopPropagation()}
        className="bg-white rounded-3xl sm:rounded-[2rem] shadow-2xl w-full max-w-lg border-2 border-gray-200 overflow-hidden flex flex-col max-h-[90vh]"
      >
        ...
        <div className="flex-1 overflow-y-auto bg-white">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="w-full bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-bold py-4 px-6 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl flex items-center justify-center gap-3 mt-6"
          >
