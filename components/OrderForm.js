  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
        className="fixed inset-0 bg-black/60 backdrop-blur-md z-[70] overflow-y-auto"
        onClick={onClose}
      ...
      >
        <div className="min-h-screen flex items-center justify-center p-4 py-8">
          ...
          >
            ...
            <div className="relative bg-gradient-to-r from-pink-500 via-purple-500 to-pink-500 p-6 sm:p-8">
            ...
            <div className="p-6 sm:p-8 max-h-[85vh] overflow-y-auto form-scroll-container" style={{ WebkitOverflowScrolling: 'touch' }}>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    maxLength={10}
                    className={`w-full pl-14 pr-4 py-3.5 text-base border-2 rounded-xl focus:ring-2 focus:ring-green-500/30 focus:border-green-500 transition-all duration-300 bg-white text-gray-900 font-light placeholder:text-gray-400 shadow-sm ${
              ...
              {/* Premium Action Button - Only WhatsApp Order */}
              <div className="pt-2 pb-2">
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="w-full bg-gradient-to-r from-green-500 via-green-600 to-green-500 hover:from-green-600 hover:via-green-700 hover:to-green-600 text-white font-semibold py-4 px-6 rounded-xl transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-xl hover:shadow-green-500/30 flex items-center justify-center gap-3 text-base relative overflow-hidden group"
                >
